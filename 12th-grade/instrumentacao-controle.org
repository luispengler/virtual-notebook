...
+ Quatro efeitos conhecidos ocorrem quando junções de materiais distintos são mantidas a temperaturas diferentes
...
Como pode ser quantificado a perda de carga nos dispositivos por pressão diferencial
